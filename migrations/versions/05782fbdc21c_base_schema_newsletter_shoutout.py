"""base schema: newsletter + shoutout

Revision ID: 05782fbdc21c
Revises: 
Create Date: 2025-08-27 14:15:44.399892
...
def upgrade():
    ...
    sa.Column('invite', sa.String(length=255), nullable=True),
    ...
    with op.batch_alter_table('newsletter_signups', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_newsletter_signups_updated_at'), ['updated_at'], unique=False)
    ...
    with op.batch_alter_table('shoutouts', schema=None) as batch_op:
    ...
    with op.batch_alter_table('sms_logs', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_sms_logs_direction', ['direction'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('sms_logs', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_sms_logs_direction')
    ...
    with op.batch_alter_table('newsletter_signups', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_newsletter_signups_updated_at'))
