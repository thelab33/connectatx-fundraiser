...
Revision ID: a187215f15ed
Revises: 
Create Date: 2025-08-14 14:34:10.645832
...
def upgrade():
    ...
    sa.Column('message_body', sasa.Text(), nullable=False),
    sa.Column('response_body', sasa.Text(), nullable=False),
    sa.Column('ai_used', sa.Boolean(), nullable=False),
    sa.Column('error', sasa.Text(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('record', postgresql.JSONB(astext_type=sasa.Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    sa.Column('impact_stats', postgresql.JSONB(astext_type=sasa.Text()).with_variant(sa.JSON(), 'sqlite'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted', sa.Boolean(), nullable=False),
    sa.PrimaryKeyConstraint('id')
